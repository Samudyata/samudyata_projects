...
**Technical**:  Artificial Intelligence, Applied Machine Learning, Deep Learning, NLP, LLMs, GenAI, Transformers, RAG,
Computer Vision, Image Processing, 3D Reconstruction, AI Prompting, Prompt Engineering, Embedded Systems


**Software & Tools**: PyTorch, TensorFlow, Keras, LangChain, Hugging Face, OpenAI, OpenCV, Scikit-learn, Simulink,
Postman, MongoDB, Grafana, Kibana, OrCAD, WSL, Linux, Git, Docker, Kubernetes, Kafka, Microsoft Office
